...
| [`05-sharc-isa-and-decoding.md`](findings/05-sharc-isa-and-decoding.md) | The SHARC+ instruction tables from the public manuals, the run of Type-NN decode corrections, and the selache cross-check |
| [`06-sharc-engine-and-startup.md`](findings/06-sharc-engine-and-startup.md) | The bounded startup probe, the frontier sprint, the machine-type consumer, the audio engine ingredients |
